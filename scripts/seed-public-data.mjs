...
const FOOD_GRADES = [
  { id: 'FG-001', name: 'Golden Dragon Restaurant',    address: '45 Main St, Colombo 07',          grade: 'A', score: 92, lastInspection: '2025-01-15', type: 'Restaurant',  permitId: 'FP-20250001', mohArea: 'Colombo MOH Area',     status: 'active',  lat: 6.9100, lng: 79.8612 },
  { id: 'FG-002', name: 'Fresh Bakery & Cafe',          address: '12 Galle Rd, Dehiwala',            grade: 'A', score: 88, lastInspection: '2025-01-10', type: 'Bakery',      permitId: 'FP-20250002', mohArea: 'Dehiwala MOH Area',     status: 'active',  lat: 6.8500, lng: 79.8675 },
  { id: 'FG-003', name: 'City Food Court',              address: '78 Kandy Rd, Kaduwela',            grade: 'B', score: 72, lastInspection: '2024-12-20', type: 'Food Court',  permitId: 'FP-20240089', mohArea: 'Kaduwela MOH Area',     status: 'active',  lat: 6.9342, lng: 79.9892 },
  { id: 'FG-004', name: 'Sunrise Hotel',                address: '200 Beach Rd, Mt. Lavinia',        grade: 'A', score: 95, lastInspection: '2025-02-01', type: 'Hotel',       permitId: 'FP-20250006', mohArea: 'Dehiwala MOH Area',     status: 'active',  lat: 6.8395, lng: 79.8634 },
  { id: 'FG-005', name: 'Corner Deli',                  address: '5 Temple Rd, Nugegoda',            grade: 'C', score: 48, lastInspection: '2024-11-25', type: 'Retail',      permitId: 'FP-20230567', mohArea: 'Colombo MOH Area',     status: 'warning', lat: 6.8723, lng: 79.8895 },
  { id: 'FG-006', name: 'Highway Rest Stop',            address: 'A1 Highway, Kottawa',              grade: 'B', score: 65, lastInspection: '2024-12-15', type: 'Restaurant',  permitId: 'FP-20240178', mohArea: 'Homagama MOH Area',    status: 'active',  lat: 6.8404, lng: 79.9580 },
  { id: 'FG-007', name: 'Royal Colombo Cafe',           address: '134 Duplication Rd, Colombo 03',  grade: 'A', score: 91, lastInspection: '2025-01-22', type: 'Restaurant',  permitId: 'FP-20240445', mohArea: 'Colombo MOH Area',     status: 'active',  lat: 6.9077, lng: 79.8512 },
  { id: 'FG-008', name: 'Mango Tree Eatery',            address: '78 High Level Rd, Maharagama',     grade: 'B', score: 71, lastInspection: '2025-01-05', type: 'Restaurant',  permitId: 'FP-20240201', mohArea: 'Maharagama MOH Area',  status: 'active',  lat: 6.8500, lng: 79.9237 },
  { id: 'FG-009', name: 'Blue Ocean Seafood',           address: '17 Harbour View, Negombo',         grade: 'B', score: 68, lastInspection: '2025-01-08', type: 'Restaurant',  permitId: 'FP-20240387', mohArea: 'Negombo MOH Area',     status: 'active',  lat: 7.2086, lng: 79.8358 },
  { id: 'FG-010', name: 'Lanka Spice Garden',           address: '33 Lake Rd, Kiribathgoda',         grade: 'A', score: 90, lastInspection: '2025-01-22', type: 'Restaurant',  permitId: 'FP-20240512', mohArea: 'Gampaha MOH Area',     status: 'active',  lat: 6.9764, lng: 79.9311 },
  { id: 'FG-011', name: 'Star Buns Bakery',             address: '22 Baseline Rd, Colombo 08',       grade: 'A', score: 86, lastInspection: '2025-01-18', type: 'Bakery',      permitId: 'FP-20240623', mohArea: 'Colombo MOH Area',     status: 'active',  lat: 6.9170, lng: 79.8758 },
  { id: 'FG-012', name: 'Perera & Sons Supermarket',    address: '10 Negombo Rd, Wattala',           grade: 'B', score: 74, lastInspection: '2024-12-30', type: 'Retail',      permitId: 'FP-20240711', mohArea: 'Gampaha MOH Area',     status: 'active',  lat: 6.9893, lng: 79.8918 },
];

      ...
      <div className="container mx-auto max-w-2xl px-4 py-8 space-y-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Card className="mt-4">
            ...
            <CardContent className="space-y-4">
              <p className="text-xs text-muted-foreground">Providing your contact details helps us follow up. You may submit anonymously.</p>
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2"><Label>NIC (optional)</Label><Input placeholder="NIC number" /></div>
              </div>
            </CardContent>
          </Card>

          <div className="mt-4 flex justify-end">
            <Button type="submit" size="lg" className="bg-orange-600 hover:bg-orange-700"><Send className="mr-2 h-4 w-4" />Submit Complaint</Button>
          </div>
        </form>
      </div>
    </div>

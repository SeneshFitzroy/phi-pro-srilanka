...
export default function OHSChecklistPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader><CardTitle className="text-base">Notes & Action Items</CardTitle></CardHeader>
        <CardContent>
          <textarea className="flex w-full rounded-md border border-input bg-background px-3 py-2 text-sm min-h-[100px]" placeholder="Record additional observations and required corrective actions..." />
        </CardContent>
      </Card>
    </div>
  );

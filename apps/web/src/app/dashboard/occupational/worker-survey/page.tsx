              ...
              <div key={r.id} className="rounded-lg border p-4">
                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div className="flex items-end pb-1">
                    <label className="flex items-center gap-2 text-sm"><input type="checkbox" className="rounded" checked={r.ppeCompliant} onChange={(e) => updateRecord(r.id, 'ppeCompliant', e.target.checked)} />PPE compliant</label>
                  </div>
                </div>
              </div>
            ))}

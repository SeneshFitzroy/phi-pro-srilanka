...
// Yjs (CRDT) + y-indexeddb (offline persistence). Concurrent tabs converge.
//
// Originally a standalone page at /dashboard/administration/h399-collab;
// now also embedded inside /dashboard/epidemiology so the live disease
// case stream feeds the Disease Trend, Cluster radar and Notifiable
// Diseases reference without dual-entry.
// ============================================================================

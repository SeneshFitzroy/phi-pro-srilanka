...
// Area Analytics — extracted from /dashboard/management/analytics so the same
// content can be embedded on the SPHI /dashboard overview. The `embedded`
// prop hides the page chrome (back button + export header).
...
export function AnalyticsContent({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  return (
    <div className="space-y-6">
      <div className={`flex items-center justify-between flex-wrap gap-3 ${embedded ? 'hidden' : ''}`}>

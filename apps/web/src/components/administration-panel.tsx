...
// Administration & Reporting panel — extracted from the old
// /dashboard/administration page so it can be embedded as a tab on the main
// dashboard (DSRM — one home, no separate route). Reporting content only;
// complaints live in their own dashboard tab via ComplaintsManager.

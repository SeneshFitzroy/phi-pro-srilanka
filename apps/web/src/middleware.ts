...
export default function middleware(req: NextRequest) {
  ...
  response.headers.set(
    ...
    [
      ...
      "connect-src 'self' https://*.firebaseio.com https://*.googleapis.com https://apis.google.com https://api.anthropic.com https://api.openai.com https://api.open-meteo.com wss://*.firebaseio.com https://us.i.posthog.com https://us.posthog.com https://us-assets.i.posthog.com https://*.sentry.io https://*.mapbox.com https://translate-pa.googleapis.com https://*.firebaseapp.com https://www.google.com https://maps.googleapis.com https://streetviewpixels-pa.googleapis.com https://nominatim.openstreetmap.org",
